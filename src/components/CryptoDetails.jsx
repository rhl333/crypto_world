...
const CryptoDetails = () => {
  ...
  let cryptoDetails = useSelector((state) => state.coins.data);
  // let coinHistory = useSelector((state) => state.coinHistory.data);
  let dispatch = useDispatch();
  useEffect(() => {
    dispatch(getCoins({ coinId, timePeriod }));
        ...
        <Col className="coin-value-statistics">
          ...
          {stats.map(({ icon, title, value }) => (
            <Col className="coin-stats">
              ...
              <Text className="stats">{value === undefined ? "" : value}</Text>
            </Col>
          ))}
        </Col>
